...
namespace MITT_HIMAWAN_SUTANTO.Repository
{
    public class Common
    {
        ...
        public static DataTable ExecuteQuery(string query,string connection)
        {
            SqlConnection con = GetConnection(connection);
        ...
        public static void ExecuteNonQuery(string Query,string ConnSql)
        {
            try
            {
                SqlConnection con = GetConnection(ConnSql);
        ...
        public static DataTable Exc_Global(string sp, object[] parameters)
        {
            ...
            DataTable dt = Common.ExecuteQuery(sql, "ConSql");
